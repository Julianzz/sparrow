...
module = angular.module("plunker.toolbar", [ "plunker.downloader"])
  ...
  template: """
    <div id="toolbar" class="btn-toolbar">
      <div class="btn-group" ng-show="scratch.isOwned()">
        <button ng-click="scratch.save()" title="{{saveTitle}}" class="btn btn-primary">
          <i class="icon-ok"></i>
          <span class="shrink"> 
            Save
          </span>
      ...
      <div class="btn-group" ng-show="scratch.isSaved()">
        <button ng-click="scratch.fork()" title="Save your changes as a fork of this Plunk" class="btn">
          <i class="icon-git-fork"></i>
          <span class="shrink"> Fork</span>
        </button>
        ...
        <ul class="dropdown-menu" ng-switch on="scratch.plunk.private">
          <li ng-switch-when="false">
            <a ng-click="scratch.fork({private: true})">
              Fork to private plunk
            </a>
          </li>
          <li ng-switch-when="true">
            <a ng-click="scratch.fork({private: false})">
              Fork to public plunk
            </a>
          </li>
        </ul>
      </div>
      <div ng-show="scratch.isOwned() && scratch.isSaved()" class="btn-group">
        <button ng-click="scratch.promptDestroy()" title="Delete the current plunk" class="btn btn-danger">
          <i class="icon-trash"></i>
        </button>
      </div>
      <div class="btn-group">
        <a href="/edit/" title="Start a new plunk from a blank slate" class="btn btn-success">
          <i class="icon-file"></i>
          <span class="shrink"> New</span>
        </a>
